...
<th><p>CIP-1694</p>
<p><a
href="https://github.com/cardano-foundation/CIPs/blob/de76120a30552ef620d96401ed7fd3e5bca1f062/CIP-1694/README.md?plain=1#L997C1-L997C78"><u>L997</u></a></p></th>
<th></th>
</tr>
<tr class="odd">
<th><a
...
bodies/process.</p></th>
<th><p>There must be a command in in the Cardano CLI allowing the user
...
also provide a term for each new member using the flag
–epoch</mark></th>
<th>Detail Pending</th>
<th></th>
<th></th>
...
threshold:</mark></p>
<blockquote>
<p><mark>When adding members</mark></p>
<p><mark>When removing members</mark></p>
<p><mark>As standalone action (no adds or removals)</mark></p>
</blockquote></th>
<th>Detail Pending</th>
<th></th>
<th></th>
...
<tr class="odd">
<th><mark>Requires the user to provide the amount in lovelace that will
be transferred from the treasury to the stake credential if the action
is ratified.</mark></th>
<th>Detail Pending</th>
<th></th>
<th></th>
...
<p><mark>The network group consists of:</mark></p>
<blockquote>
...
<p><mark>The economic group consists of:</mark></p>
<blockquote>
...
<p><mark>The technical group consists of:</mark></p>
<blockquote>
...
<p><mark>The governance group consists of all the new protocol
parameters that are introduced in this CIP:</mark></p>
<blockquote>
...
<tr class="header">
<th><mark>The command requires the user to input the new protocol
version number</mark></th>
<th>Detail Pending</th>
<th></th>
<th></th>
<th></th>
...
<th><mark>Transaction build has a new flag to supply a proposal file as
...
<p>So that I can later sign and submit to the chain</p>
<p>transaction build</p></th>
<th><mark>Transaction build has a new flag to supply a vote file as
input for the transaction body</mark></th>
<th>Detail Pending</th>
<th></th>
<th></th>
...
where<br />
<br />
reg_cert = (7, stake_credential, coin)</mark></th>
<th>Detail Pending</th>
<th></th>
<th></th>
<th></th>
...
where<br />
<br />
unreg_cert = (8, stake_credential, coin)</mark></th>
<th>Detail Pending</th>
<th></th>
<th></th>
<th></th>
...
where<br />
<br />
vote_deleg_cert = (9, stake_credential, drep)</mark></th>
<th>Detail Pending</th>
<th></th>
<th></th>
<th></th>
...
where<br />
<br />
stake_vote_deleg_cert = (10, stake_credential, pool_keyhash,
drep)</mark></th>
<th>Detail Pending</th>
<th></th>
<th></th>
...
information:</mark></p>
<blockquote>
<p><mark>Previous protocol parameters</mark></p>
<p><mark>Current protocol parameters</mark></p>
<p><mark>Last enacted governance actions IDs for committee,
constitution, hardfork initiation and parameter updates</mark></p>
<p><mark>Ratified governance actions that will be enacted at next epoch
transition</mark></p>
<p><mark>Active governance actions proposals including their type, stake
address that collects the deposit, governance action id, expiration,
spo, drep and cc votes</mark></p>
</blockquote></th>
<th>Detail Pending</th>
<th></th>
<th></th>
